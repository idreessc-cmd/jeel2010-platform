            ...
            <div className="container footer-grid">
                <div className="footer-col footer-about">
                    ...
                    <div className="social-links">
                        ...
                        <a href="https://youtube.com" target="_blank" rel="noreferrer" className="social-link" aria-label="يوتيوب" style={{ display: 'inline-flex', alignItems: 'center', justifyContent: 'center' }}>
                        ...
                        <a href="https://telegram.org" target="_blank" rel="noreferrer" className="social-link" aria-label="تليجرام" style={{ display: 'inline-flex', alignItems: 'center', justifyContent: 'center' }}>
                            <Send size={18} />
                        </a>
                        <a href="https://wa.me/201012345678" target="_blank" rel="noreferrer" className="social-link" aria-label="واتساب" style={{ display: 'inline-flex', alignItems: 'center', justifyContent: 'center' }}>
