            ...
            <div className="container footer-grid">
                <div className="footer-col footer-about">
                    ...
                    <div className="social-links">
                        ...
                        <a href="https://www.youtube.com/@امتحان_النجاح" target="_blank" rel="noreferrer" className="social-link" aria-label="يوتيوب" style={{ display: 'inline-flex', alignItems: 'center', justifyContent: 'center' }}>
                        ...
                        <a href="https://www.instagram.com/1_2010_2009_2008/" target="_blank" rel="noreferrer" className="social-link" aria-label="انستجرام" style={{ display: 'inline-flex', alignItems: 'center', justifyContent: 'center' }}>
                ...
                <div className="footer-col footer-links">
                    ...
                    <ul>
                        ...
                        <li><Link to="/subjects">المواد</Link></li>
                        <li><Link to="/subscription">الاشتراك</Link></li>
